...
user_pref("4chan.enable_thread_watch", false);
...
user_pref("4chan.last_run_version", "0.4.5.15");
...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1273702128);
user_pref("app.update.lastUpdateTime.background-update-timer", 1273702110);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1273702246);
user_pref("app.update.lastUpdateTime.microsummary-generator-update-timer", 1273608483);
user_pref("app.update.lastUpdateTime.places-maintenance-timer", 1273701972);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1273702230);
...
user_pref("extensions.adblockplus.currentVersion", "1.2");
user_pref("extensions.enabledItems", "hidemenubar@moztw.org:3.6.20100218,{46551EC9-40F0-4e47-8E18-8E5CF550CFB8}:1.0.8,{9AA46F4F-4DC7-4c06-97AF-5035170633FE}:0.4.5.15,{e4a8a97b-f2ed-450b-b12d-ee082ba24781}:0.8.20100408.6,{d10d0bf8-f5b5-c8b4-a8b2-2b9879e08c5d}:1.2,{972ce4c6-7e08-4474-a285-3208198ce6fd}:3.6.3");
...
user_pref("idle.lastDailyNotification", 1273702103);
user_pref("intl.charsetmenu.browser.cache", "ISO-8859-1, UTF-8");
user_pref("network.cookie.prefsMigrated", true);
user_pref("places.last_vacuum", 1273610960);
user_pref("pref.privacy.disable_button.view_passwords", false);
user_pref("privacy.cpd.siteSettings", true);
user_pref("privacy.sanitize.migrateFx3Prefs", true);
user_pref("privacy.sanitize.timeSpan", 0);
user_pref("urlclassifier.keyupdatetime.https://sb-ssl.google.com/safebrowsing/newkey", 1276202045);
