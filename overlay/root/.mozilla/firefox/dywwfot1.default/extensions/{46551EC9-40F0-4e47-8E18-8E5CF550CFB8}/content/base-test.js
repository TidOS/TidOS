...
function testStyleSave() {
	...
	style.init(url, updateUrl, md5Url, name, code, false, null);
...
function testStyleApplied() {
	var style = Components.classes["@userstyles.org/style;1"].createInstance(Components.interfaces.stylishStyle);
	style.init(null, null, null, "Unit test", "button { text-decoration: underline !important;}", true, null);
...
function testUrlMatch() {
	var style = Components.classes["@userstyles.org/style;1"].createInstance(Components.interfaces.stylishStyle);
	style.init(null, null, null, "Unit test", "@-moz-document url('http://google.com') { * {color: blue}}", false, null);
	function v() {
...
function testUrlPrefixMatch() {
	var style = Components.classes["@userstyles.org/style;1"].createInstance(Components.interfaces.stylishStyle);
	style.init(null, null, null, "Unit test", "@-moz-document url-prefix('http://google.com') { * {color: blue}}", false, null);
	function v() {
		assert("Style not marked as applied.", style.appliesToUrl("http://google.com"));
...
function testDomainMatch() {
	var style = Components.classes["@userstyles.org/style;1"].createInstance(Components.interfaces.stylishStyle);
	style.init(null, null, null, "Unit test", "@-moz-document domain('google.com') { * {color: blue}}", false, null);
	function v() {
...
function testLoadAndUpdateCode() {
	try {
		...
		style.init(null, null, null, "Unit test - load and update code", code, true, null);
		style.save();
		//now load it
		style = Style.find(style.id, Style.REGISTER_STYLE_ON_CHANGE);
		//update it
...
function testLoadAndUpdateName() {
	try {
		...
		var style = Components.classes["@userstyles.org/style;1"].createInstance(Components.interfaces.stylishStyle);
		var code = "* {font-style: italic;}";
		style.init(null, null, null, "Unit test - load and update name", code, true, null);
		style.save();
		//now load it
		style = Style.find(style.id, Style.REGISTER_STYLE_ON_CHANGE);
		//update it
...
function testPreviewEnabled() {
	try {
		var style = Components.classes["@userstyles.org/style;1"].createInstance(Components.interfaces.stylishStyle);
		var code = "* {font-style: italic;}";
		style.init(null, null, null, "Unit test - preview", code, true, null);
...
function testPreviewDisabled() {
	try {
		var style = Components.classes["@userstyles.org/style;1"].createInstance(Components.interfaces.stylishStyle);
		var code = "* {font-style: italic;}";
		style.init(null, null, null, "Unit test - preview", code, false, null);
...
function testType() {
	...
	var style = Components.classes["@userstyles.org/style;1"].createInstance(Components.interfaces.stylishStyle);
	style.init(null, null, null, "Unit test", "* {color: blue}", false, null);
...
function testFindByUrl() {
	try {
		...
		style.init(url, null, null, "Unit test", "/**/", false, null);
		style.save();
...
function testUpdateMd5NoUpdate() {
	var style = Components.classes["@userstyles.org/style;1"].createInstance(Components.interfaces.stylishStyle);
	style.init(null, null, "data:text/plain,2642306a8b25001880ccb55e68456165", "testUpdateMd5NoUpdate", "* {color: blue}", false, null);
	observerService.addObserver(updateMd5NoUpdateObserver, "stylish-style-update-check-done", false);
	style.checkForUpdates();
}
...
function testUpdateMd5WithUpdate() {
	var style = Components.classes["@userstyles.org/style;1"].createInstance(Components.interfaces.stylishStyle);
	style.init(null, null, "data:text/plain,adifferentchecksum", "testUpdateMd5WithUpdate", "* {color: blue}", false, null);
...
function testUpdateUrlNoUpdate() {
	var style = Components.classes["@userstyles.org/style;1"].createInstance(Components.interfaces.stylishStyle);
	style.init(null, "data:text/css,* {color: blue}", null, "testUpdateUrlNoUpdate", "* {color: blue}", false, null);
...
function testUpdateUrlWithUpdate() {
	var style = Components.classes["@userstyles.org/style;1"].createInstance(Components.interfaces.stylishStyle);
	style.init(null, "data:text/css,* { color: red}", null, "testUpdateUrlWithUpdate", "* {color: blue}", false, null);
...
function testUpdateNotAvailable() {
	var style = Components.classes["@userstyles.org/style;1"].createInstance(Components.interfaces.stylishStyle);
	style.init(null, null, null, "testUpdateNotAvailable", "* {color: blue}", false, null);
...
function testRunUpdateAvailable() {
	...
	runUpdateAvailableStyle.init(null, "data:text/css,* {color: red}", null, "Unit test testRunUpdateAvailable", "* {color: blue}", false, null);
...
function testRunUpdateNotAvailable() {
	...
	runUpdateNotAvailableStyle.init(null, null, null, "Unit test testRunUpdateNotAvailable", "* {color: blue}", false, null);
